...
- [ ] 报头三段式齐全：期数/售價、报名大字、日期/農曆/節氣
- [ ] 3px 双线与 1px 细线层次分明；全站零圆角、零阴影
- [ ] 头条正文三栏流动，栏宽实测 320–360px，栏间 1px 线
- [ ] 首字下沉占 2–3 行
- [ ] 噪点、暗角、灰度图三件套全部生效
- [ ] 套红仅出现在报头/印章/栏目强调处
- [ ] 印章为套红圆形、带旋转与盖印质感
- [ ] 全页零 `<script>`；HTML 语义化（header/nav/main/section/article/footer）
- [ ] 字体全部自托管：DevTools Network 中 woff2 均 200、无外网字体请求
- [ ] 375px 宽无横向滚动、版面可读
- [ ] 本地 git 仓按任务粒度提交，未配置远端
